            ...
            <div className='h-screen max-w-[80%] mx-auto flex flex-col gap-2 items-center justify-center'>
                <div className='min-w-[90%] md:min-w-120'>
                    ...
                    <div className='bg-[#191C22]'>
                        ...
                        <div className='p-8'>
                            <button onClick={handleGoogleAuth} className='text-white bg-[#32353C] flex gap-2 p-3 w-full items-center justify-center rounded-md text-xs md:text-base'> <span><svg className='w-4 md:w-5 h-4 md:h-5' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
